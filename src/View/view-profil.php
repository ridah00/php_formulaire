        ...
        <div class="col-lg-10 p-0">
            <div class="mt-5">
                <div class="d-flex align-items-center justify-content-evenly gap-lg-5 gap-2 mb-5">
                    <img src="<?= '../../assets/img/' . $the_user['user_id'] . '/avatar/' . $the_user['user_avatar'] ?>" class="profile_image rounded-circle" title="<?= $the_user['user_pseudo'] ?>" alt="<?= 'Photo de' . $the_user['user_id'] ?>">
                    <div>
                        <div class="d-flex align-items-center gap-3">
                            <p class="fs-1 m-0"><?= $the_user['user_pseudo'] ?></p>
                            <?= ($_SESSION['user_id'] == $the_user['user_id']) ? '<a class="btn btn-outline-secondary">Modifier mon profil</a>' : '' ?>
                        ...
                        <p class="mt-2"><?= $the_user['user_firstname'] . ' ' . $the_user['user_lastname'] ?><br>Subscribe to my Youtube Channel!</p>
                    </div>
                </div>
            </div>
