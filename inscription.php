        ...
        <form method="POST" novalidate>
            <div class="row m-0 gap-3">
                <div class="col-sm p-0">
                    <label for="nom" class="form-label">Nom</label><span class="px-2 text-danger"><?= $errors['lastname'] ?? '' ?></span>
                    <input type="text" class="form-control" name="lastname" id="nom" placeholder="Entrez votre nom" value="<?= $_POST["lastname"] ?? '' ?>" required>
                </div>
                <div class="col-sm p-0">
                    <label for="prenom" class="form-label">Prénom</label><span class="px-2 text-danger"><?= $errors['firstname'] ?? '' ?></span>
            ...
            <div class="col-sm p-0">
                    <label for="pseudo" class="form-label">Pseudo</label><span class="px-2 text-danger"><?= $errors['pseudo'] ?? '' ?></span>
                    <input type="text" class="form-control" name="pseudo" id="pseudo" placeholder="Entrez votre pseudo" value="<?= $_POST["pseudo"] ?? '' ?>" required>
                </div>
            <div>
                <label for="email" class="form-label">Email</label><span class="px-2 text-danger"><?= $errors['mail'] ?? '' ?></span>
                <input type="email" class="form-control" name="mail" id="email" placeholder="Entrez votre email" value="<?= $_POST["mail"] ?? '' ?>" required>
            </div>
            <div class="row m-0 gap-3">
                <div class="col-sm p-0">
                    <label for="mdp" class="form-label">Mot de passe</label><span class="px-2 text-danger"><?= $errors['password'] ?? '' ?></span>
                    <input type="password" class="form-control" name="password" id="mdp" placeholder="Entrez votre mot de passe" value="<?= $_POST["password"] ?? '' ?>"
                        required>
                </div>
                <div class="col-sm p-0">
                    <label for="confirmationmdp" class="form-label">Confirmation du mot de passe</label><span class="px-2 text-danger"><?= $errors['c_password'] ?? '' ?></span>
                    <input type="password" class="form-control" name="c_password" id="confirmationmdp" value="<?= $_POST["c_password"] ?? '' ?>"
                        placeholder="Confirmez votre mot de passe" required>
                </div>
            </div>
            <div class="row m-0 gap-3">
                <div class="col-sm p-0">
                    <label for="date_naissance" class="form-label">Date de naissance</label><span class="px-2 text-danger"><?= $errors['birthdate'] ?? '' ?></span>
                    <input type="date" max="<?= $date ?>" class="form-control" name="birthdate" id="date_naissance" value="<?= $_POST["birthdate"] ?? '' ?>" required>
                </div>
                <div class="col-sm p-0">
                    <label class="form-label">Genre</label><span class="px-2 text-danger"><?= $errors['gender'] ?? '' ?></span>
            ...
            <div class="form-check d-flex justify-content-center align-items-center m-3">
                ...
                <label class="form-check-label mx-2" for="conditions">J'accepte les conditions d'utilisation</label><span class="px-2 text-danger"><?= $errors['condition'] ?? '' ?></span>
            </div>
